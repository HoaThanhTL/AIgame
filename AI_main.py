...
def CreateMainPage():
    root.title('Đồ án: Công Nghệ Thông Tin') 
    ...
    lb_Intro = Label(root, text="ĐỒ ÁN CÔNG NGHỆ THÔNG TIN",
    ...
    lb_Member = Label(root, text="21110742 - Võ Thị Minh Thục",
                    font='arial 14', bg="#073810", fg="#b8d6be", borderwidth='3', relief='sunken', anchor='center')
    lb_Member.grid(column=0, row=0)
    lb_Member.place(x=180, y=100)

    btn_EDA = Button(root, text="GAME BOO-KOBAN", width=20, font="arial 12", background='#0d4f19', fg="white", borderwidth='3', relief='sunken', activebackground='gray', border=5, command=sokoban)
    btn_EDA.place(x=215, y=300)

    btn_EDA = Button(root, text="GAME 8-PUZZLE", width=20, font="arial 12", background='#0d4f19', fg="white", borderwidth='3', relief='sunken', activebackground='gray', border=5, command=eightpuzzle)
    btn_EDA.place(x=215, y=360)

    btn_toggle_sound = Button(root, text="Bật/Tắt Âm Thanh", width=20, font="arial 12", background='#0d4f19', fg="white", borderwidth='3', relief='sunken', activebackground='gray', border=5, command=toggle_sound)
    btn_toggle_sound.pack()
    btn_toggle_sound.place(x=215, y=420)

    btn_Exit=Button(root,text="ĐÓNG GIAO DIỆN", width=20, font="arial 12", background='#0d4f19', fg="white", borderwidth='3', relief='sunken', activebackground='gray', border=5, command=Thoat)
